            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom p-3 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold text-coffee mb-0">
                        <i class="bi bi-plus-circle-fill me-2 text-gold"></i>Create New Product
                    </h6>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                <label for="product_price" class="form-label fw-semibold">Price (Rp) <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="product_stock" class="form-label fw-semibold">Initial Stock <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <label for="product_description" class="form-label fw-semibold">Menu Description</label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="product_photo_input" class="form-label fw-semibold">Product Photo</label>
                                <input type="file" name="product_photo" id="product_photo_input"
                                       class="form-control @error('product_photo') is-invalid @enderror"
                                       accept="image/*">
                                <div class="form-text small">Format JPG, PNG, WEBP, SVG (Maks. 2MB).</div>
                                @error('product_photo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch mt-2">
                                    ...
                                    <label class="form-check-label fw-semibold" for="is_active">
                                        Product Active (Tampilkan di Kasir POS)
                                    </label>
                                </div>
                            </div>
                        </div>
