...
<div class="pos-container">
    ...
    <aside class="pos-category-nav">
        <div class="d-none d-lg-block mb-3">
            <span class="text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Category Menu</span>
        </div>

        <button type="button" class="category-pill-btn active" data-category="all">
            <span><i class="bi bi-grid-fill me-2 text-warning"></i> All </span>
        </button>
    ...
    <section class="pos-products-area d-flex flex-column">
        ...
        <div class="mb-3 d-flex flex-column flex-sm-row gap-2 justify-content-between align-items-sm-center">
            ...
            <div class="text-muted small">
                <i class="bi bi-info-circle me-1"></i> Click the menu to add to the order.
            </div>
        </div>
    ...
    <aside class="pos-cart-panel">
        ...
        <div class="p-3 border-bottom d-flex align-items-center justify-content-between bg-white">
            <div class="d-flex align-items-center gap-2">
                ...
                <h6 class="fw-bold mb-0 text-coffee">Customer Order</h6>
            </div>
            <div class="d-flex align-items-center gap-2">
        ...
        <div class="cart-items-container">
            <div id="cartEmptyState" class="text-center py-5">
                ...
                <p class="mt-2 text-muted fw-semibold mb-0">The basket is still empty</p>
                <p class="text-muted small">Select the menu on the left to start the order.</p>
            </div>
        ...
        <div class="cart-summary-box">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <span class="fw-bold fs-6 text-coffee">Total Payment</span>
...
<div class="modal fade" id="checkoutModal" tabindex="-1" aria-labelledby="checkoutModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-coffee text-black">
                <h5 class="modal-title fw-bold" id="checkoutModalLabel">
                    <i class="bi bi-wallet-fill me-2 text-warning"></i>Transaction Payment
                </h5>
            ...
            <div class="modal-body p-4">
                ...
                <div class="card border mb-4 bg-light">
                    <div class="card-header bg-white py-2 border-bottom">
                        <span class="fw-bold text-coffee small text-uppercase"><i class="bi bi-receipt me-1"></i> Payment Summary </span>
                    </div>
                    <div class="card-body p-3">
                        <table class="table table-sm table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-muted">Tax (11%)</td>
                                    <td class="text-end fw-semibold" id="modalTaxAmount">Rp 0</td>
                                </tr>
                                <tr class="border-top">
                                    <td class="fw-bold text-coffee fs-6 pt-2">Total Payment</td>
                ...
                <div class="mb-4">
                    <label class="form-label fw-bold text-dark small text-uppercase">Choose a Payment Method</label>
                    <div class="row g-2">
                        <div class="col-6">
                ...
                <div id="qrisPaymentSection" style="display: none;" class="p-3 bg-light rounded-3 text-center border mb-3">
                    ...
                    <p class="fw-bold text-coffee mb-1 mt-2">Customer QRIS Scan</p>
                    <p class="small text-muted mb-0">Payment in the direct process without change.</p>
                </div>

                <!-- Cash Payment Section -->
                <div id="cashPaymentSection">
                    <div class="mb-3">
                        <label for="cashAmountInput" class="form-label fw-semibold">Amount Paid (Rp) <span class="text-danger">*</span></label>
                        ...
                        <div id="cashValidationMsg" class="text-danger small mt-1 fw-semibold" style="display: none;">
                            <i class="bi bi-exclamation-circle me-1"></i> Insufficient payment amount.
                        </div>
                    </div>

                    <!-- Quick Cash Amounts -->
                    <div class="mb-3">
                        <span class="text-muted small fw-semibold d-block mb-1">Quick Nominal Option:</span>
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary btn-quick-cash" data-val="exact">Money fit</button>
            ...
            <div class="modal-footer bg-light">
                ...
                <button type="button" class="btn btn-coffee px-4" id="btnSubmitPayment">
                    <i class="bi bi-check-circle me-1"></i> Payment Process & Done
                </button>
            </div>
        </div>
    </div>
